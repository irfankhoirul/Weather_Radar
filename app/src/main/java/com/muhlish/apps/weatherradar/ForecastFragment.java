package com.muhlish.apps.weatherradar;
...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            new FetchWeatherTask().execute("Surabaya");
            return true;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        forecastView = (ListView) rootView.findViewById(R.id.listview_forecast);
        forecast = new ArrayList<>();
        for (int i = 0; i < 5; i++) {
            forecast.add(i, "Loading data ...");
        }
        new FetchWeatherTask().execute("Surabaya");
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String[] params) {
            ...
            try {
                ...
                //            "q=Surabaya&mode=json&units=metric&cnt=7&appid=2bf9d90d07c83cf9aa1740c453223b07");
                ...
                Uri buildUrl = Uri.parse(FORECAST_BASE_URL).buildUpon()
                        ...
                        .appendQueryParameter(APPID_PARAM, "2bf9d90d07c83cf9aa1740c453223b07")
                        .build();
